...
## Project Structure
    ...
    ├── restless_union_42737  # Django project configurations
...
1. Clone this repo and `cd restless_union_42737`
...
2. Clone this repo and `cd restless_union_42737`
