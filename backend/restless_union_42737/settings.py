"""
Django settings for restless_union_42737 project.
...
ROOT_URLCONF = 'restless_union_42737.urls'
...
WSGI_APPLICATION = 'restless_union_42737.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_union_42737 API",
    "DESCRIPTION": "API documentation for restless_union_42737 App",
    "VERSION": "v1",
}
